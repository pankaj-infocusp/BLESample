...
public abstract class Hilt_HazardFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HazardFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HazardFragment_GeneratedInjector) this.generatedComponent()).injectHazardFragment(UnsafeCasts.<HazardFragment>unsafeCast(this));
    }
  }
