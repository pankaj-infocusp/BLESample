...
public abstract class Hilt_CheckInFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CheckInFragment() {
    super();
  }

  Hilt_CheckInFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CheckInFragment_GeneratedInjector) this.generatedComponent()).injectCheckInFragment(UnsafeCasts.<CheckInFragment>unsafeCast(this));
    }
  }
