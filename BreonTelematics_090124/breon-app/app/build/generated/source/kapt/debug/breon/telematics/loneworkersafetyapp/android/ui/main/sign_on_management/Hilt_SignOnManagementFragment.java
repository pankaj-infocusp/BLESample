...
public abstract class Hilt_SignOnManagementFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SignOnManagementFragment() {
    super();
  }

  Hilt_SignOnManagementFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SignOnManagementFragment_GeneratedInjector) this.generatedComponent()).injectSignOnManagementFragment(UnsafeCasts.<SignOnManagementFragment>unsafeCast(this));
    }
  }
