...
public abstract class Hilt_AssistFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AssistFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AssistFragment_GeneratedInjector) this.generatedComponent()).injectAssistFragment(UnsafeCasts.<AssistFragment>unsafeCast(this));
    }
  }
