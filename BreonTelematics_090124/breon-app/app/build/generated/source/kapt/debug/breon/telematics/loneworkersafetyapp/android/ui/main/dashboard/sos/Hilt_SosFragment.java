...
public abstract class Hilt_SosFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SosFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SosFragment_GeneratedInjector) this.generatedComponent()).injectSosFragment(UnsafeCasts.<SosFragment>unsafeCast(this));
    }
  }
